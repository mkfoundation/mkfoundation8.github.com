if (typeof fversion === 'undefined') {
    ...
    if (document.location.href.indexOf('betamode=') > -1) {
        ...
        if (document.location.href.indexOf('betamode=local') > -1) {
            var betapath = 'http://localhost:8989/assets';
        } else if (document.location.href.indexOf('betamode=webstandards') > -1) {
            var betapath = 'http://webstandards.us.education.com:8989/assets';
        } else {
            var betapath = '//www.education.com/webfolder/s/assets/' + betavers;
        }
    }
}
function checkbetamode(file, fv) {
    if ((document.location.href.indexOf('betamode=') > 0 && !fversion[file]) || (document.location.href.indexOf('betamode=') > 0 && fversion[file] != 'betamode')) {
        fversion[file] = 'betamode';
        document.write('<script data-bmode="true" src="' + betapath + '/js/' + file + '.js"></script>');
        throw new Error("BETA MODE - DEFAULT " + file.toUpperCase() + " SCRIPT CANCELLED ");
    } else {
        fversion[file] = fv;
    }
}
